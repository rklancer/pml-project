...
(One reason to write `doPrediction` in the following way was that it made it easy to debug the complete logic of training and model validation code on small "training" and "testing" subsets of the cleaned training data first.)
